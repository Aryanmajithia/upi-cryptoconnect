    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-[700px] space-y-8 bg-zinc-900 p-8 rounded-lg shadow-lg">
          ...
          >
            <span className="mr-2">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M19 10c0-1.55-.41-2.99-1.12-4.23H10v8.05h5.53c-.23 1.2-.86 2.26-1.78 3.09v2.55h2.88c1.68-1.55 2.64-3.82 2.64-6.46z"
                  clipRule="evenodd"
                />
                <path
                  fillRule="evenodd"
                  d="M10 20c2.4 0 4.37-.82 5.86-2.22l-2.88-2.55c-.8.53-1.81.84-2.98.84-2.28 0-4.21-1.54-4.88-3.63H1V15c1.68 3.32 5.38 5.74 9 5.74z"
                  clipRule="evenodd"
                />
                <path
                  fillRule="evenodd"
                  d="M5.12 12c-.11-.54-.17-1.11-.17-1.69s.06-1.15.17-1.69V7.39H1c-.57 1.05-.88 2.25-.88 3.61s.31 2.56.88 3.61l4.12-3.62z"
                  clipRule="evenodd"
                />
                <path
                  fillRule="evenodd"
                  d="M10 3.13c1.25 0 2.37.42 3.26 1.25l2.33-2.33C14.37.53 12.4 0 10 0 5.38 0 1.68 2.42 0 5.74l2.88 2.55C5.79 4.67 7.72 3.13 10 3.13z"
                  clipRule="evenodd"
                />
              </svg>
            </span>
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          ...
          <Link
            to="/register"
            className="ml-1 font-medium text-green-400 hover:text-green-500"
          >
            Register here
          </Link>
        </div>
